...
def createScene(rootNode):
    ...
    em_mo = em_node.addObject('MechanicalObject', template='Rigid3d', 
                               position=[0.02, 0.05, 0.05, 0, 0, 0, 1])
    ...
    wire_mo = gw_node.addObject('MechanicalObject', name='dof', template='Rigid3d', position=positions)
    ...
    section = gw_node.addObject('RodStraightSection', name='section', 
                                youngModulus=E, shearModulus=G, radius=radius)
    
    gw_node.addObject('WireRestShape', name='rest_shape', template='Rigid3d', straightLength=L, length=L, numEdges=N-1)
    gw_node.addObject('WireBeamInterpolation', name='Interpol', WireRestShape='@rest_shape', radius=radius)
    gw_node.addObject('AdaptiveBeamForceFieldAndMapper', name='BeamFF', massDensity=6500, interpolation='@Interpol')
    ...
    coll_node.addObject('MechanicalObject', name='c_dof', template='Vec3d')
    ...
    vessel_node.addObject('MechanicalObject', template='Vec3d')
    ...
    vis_gw.addObject('MechanicalObject', name='v_dof', template='Vec3d')
